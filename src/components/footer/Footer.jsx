...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: "#f04e0f" }} className="text-white">
      ...
      <div className="footer p-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-10">
        ...
        <aside className="max-w-sm">
          ...
          <Logo width={160} />
          <p className="text-sm leading-relaxed mb-4 text-orange-100">
            দেশের সবচেয়ে তাজা ফলমূল পৌঁছে যায় নিরাপদ ও বিশ্বস্ত উপায়ে। বাগান থেকে সরাসরি বাছাই করা ফল আপনার দরজায়।
          </p>
        ...
        <nav className="flex flex-col gap-2">
          ...
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">Home</a>
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">Shop</a>
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">Reviews</a>
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">Track Order</a>
        </nav>

        {/* Categories */}
        <nav className="flex flex-col gap-2">
          <header className="footer-title text-white opacity-100 text-lg mb-2">Categories</header>
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">রাজশাহীর আম (Mango)</a>
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">তাজা আপেল (Apple)</a>
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">আনারস (Pineapple)</a>
          <a href="#" className="link link-hover text-orange-100 hover:text-white transition-colors">আঙ্গুর (Grapes)</a>
        </nav>
        ...
        <nav className="flex flex-col gap-3">
          ...
          <div className="flex items-start gap-3">
            <FaMapMarkerAlt className="mt-1 text-orange-200 text-lg shrink-0" />
            <p className="text-sm text-orange-100">Folmondi Head Office,<br />Dhaka, Bangladesh</p>
          </div>
          <div className="flex items-center gap-3">
            <FaPhoneAlt className="text-orange-200 shrink-0" />
            <p className="text-sm text-orange-100">+880 1234 567 890</p>
          </div>
          <div className="flex items-center gap-3">
            <FaEnvelope className="text-orange-200 shrink-0" />
            <p className="text-sm text-orange-100">support@folmondi.com</p>
          </div>
        </nav>
      </div>
      ...
      <div style={{ backgroundColor: "rgba(0,0,0,0.15)", borderTop: "1px solid rgba(255,255,255,0.15)" }}>
        <div className="max-w-7xl mx-auto px-10 py-5 flex flex-col sm:flex-row justify-between items-center text-sm text-orange-100">
          <p>© {new Date().getFullYear()} Folmondi.com. All rights reserved.</p>
          <div className="flex gap-6 mt-4 sm:mt-0">
            <a href="#" className="hover:text-white transition-colors font-medium">Terms & Conditions</a>
