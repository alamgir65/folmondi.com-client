    ...
    <footer className="text-white bg-black">
      ...
      <div style={{ backgroundColor: "rgba(0,0,0,0.15)", borderTop: "1px solid rgba(255,255,255,0.15)" }}>
        <div className="max-w-7xl mx-auto px-10 py-5 flex flex-col sm:flex-row justify-between items-center text-sm">
          <p>© {new Date().getFullYear()} Folmondi.com. All rights reserved.</p>
          <div className="flex gap-6 mt-4 sm:mt-0">
            <a href="#" className="text-white transition-colors font-medium">Terms & Conditions</a>
            <a href="#" className="text-white transition-colors font-medium">Privacy Policy</a>
          </div>
        </div>
      </div>
