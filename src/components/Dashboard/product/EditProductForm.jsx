...
export default function EditProductForm({ product_id,setEditRow, onCancel }) {
  ...
  // FIX 1: added [product, reset] dependency array to prevent infinite re-render
  useEffect(() => {
  ...
  if (isSuccess) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-5 text-center px-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-1">Product Updated!</h2>
          <p className="text-sm text-gray-400">Your product has been saved successfully.</p>
        </div>
        <div className="flex gap-3">
          {/* FIX 4: wire up onSave / onCancel props */}
          <button
            onClick={after_success}
  ...
  return (
    <div className="max-w-4xl mx-auto py-6 px-2 sm:px-0">
      ...
      <div className="mb-7">
        ...
        <p className="text-sm text-gray-400 mt-0.5">Update the details below to edit this product.</p>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            {finalPrice && discount > 0 && (
              <div className="sm:col-span-3 flex items-center gap-3 px-4 py-3 rounded-xl border text-sm bg-(--cream-light) border-(--orange-mid)">
